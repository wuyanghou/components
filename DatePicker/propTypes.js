...
export const datePickerPropTypes = {
  ...
  disabledDate: PropTypes.func,  //获取要禁用的日期
  ...
  popupPlacement: PropTypes.oneOf(['bottomLeft', 'bottomRight', 'topLeft', 'topRight']),  //日期选择面板弹出位置
}

export const datePickerDefaultPropTypes = {
  disabledDate: noop,
